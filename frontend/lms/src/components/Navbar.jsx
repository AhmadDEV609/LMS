        ...
        <>
            <nav className="w-full bg-white/90 backdrop-blur-lg border-b border-sky-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {user ? (
                                ...
                                >
                                    ...
                                    {dropdown && (
                                        <div className="absolute right-0 top-12 w-56 bg-white shadow-xl border rounded-xl z-50 overflow-hidden">
                            ...
                            <button
                                ...
                                className="lg:hidden flex items-center justify-center w-10 h-10 rounded-lg hover:bg-sky-50 text-slate-700 transition"
                    ...
                    {/* Mobile Menu */}
                    <div
                        className={`lg:hidden overflow-hidden transition-all duration-500 ease-in-out ${mobileMenu
