...
import InstructorProtected from './InstructorProtected'
                    ...
                    <div className="grid md:grid-cols-2 items-center gap-x-8 gap-y-12">
                        <div className="max-w-md mx-auto w-full p-2 md:p-4">
                            ...
                            <div className="mt-6 text-slate-900 text-sm text-center">
                                ...
                                <Link to={'/signup'} className="text-blue-700 hover:underline ml-1 font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded">
